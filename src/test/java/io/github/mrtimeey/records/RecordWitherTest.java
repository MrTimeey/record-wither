...
class RecordWitherTest {
    ...
    private final TestRecord base = new TestRecord("Test", "RecordWither", 3, true, 1.5, Status.ACTIVE);
    ...
    void testWith_integerValue() {
        ...
        assertThat(result).isEqualTo(new TestRecord("Test", "RecordWither", 42, true, 1.5, Status.ACTIVE));
    }
    ...
    void testWith_stringName() {
        ...
        assertThat(result).isEqualTo(new TestRecord("Neu", "RecordWither", 3, true, 1.5, Status.ACTIVE));
    }
    ...
    void testWith_booleanFlag() {
        ...
        assertThat(result).isEqualTo(new TestRecord("Test", "RecordWither", 3, false, 1.5, Status.ACTIVE));
    }
    ...
    void testWith_doubleScore() {
        ...
        assertThat(result).isEqualTo(new TestRecord("Test", "RecordWither", 3, true, 9.99, Status.ACTIVE));
    }
    ...
    void testWith_enumStatus() {
        ...
        assertThat(result).isEqualTo(new TestRecord("Test", "RecordWither", 3, true, 1.5, Status.INACTIVE));
    }
}
